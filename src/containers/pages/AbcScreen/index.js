...
import { pencil,book, abc,elephant, photo, back } from '../../../assets/Image';
  ...
  return(
    ...
    <View style={{flex:1,backgroundColor: '#F7F7F7'}}>
      <View style={{flex:1,backgroundColor: 'orange',borderBottomLeftRadius:50,borderBottomRightRadius:50}}>
        ...
        <View style={{flex:1}}>
        <Image source={abc} style={{width:250,height:250,alignSelf:'center',marginBottom:20}}></Image>
        </View>
      </View>
      <View style={{flex:1,marginTop:30,marginBottom:40}}>  
        <TouchableOpacity onPress={() => navigation.navigate('AbcLat')} style={{height:170,backgroundColor:'#FFFFFF',marginHorizontal:70,borderRadius:30,marginTop:20,flexDirection:'row'}}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('SoalScreen',{name:1})} style={{height:170,backgroundColor:'#FFFFFF',marginHorizontal:70,borderRadius:30,marginTop:20,flexDirection:'row'}}>
